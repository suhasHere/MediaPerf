...
"""
from mediaperf import media_utils
...
class audio_pc(TmBase):
    """
    Class to playback audio via Peer Connection
    """
    tpcycles = 1
    url = 'startup_test/media/pc_audio_mozcapture.html'
    timeout = 360 
