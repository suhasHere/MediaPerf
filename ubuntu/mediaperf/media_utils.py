...
"""
 ...
 1. Silence Removal
 2. PESQ based MOS measurement.
 3. Only .WAV input file format is supported.
"""

"""
TODO:
0. Support more auido formats and lengths
1. Make tools support across platforms. Currently we support LINUX only
2. Improve Error Checking
3. Optionally, allow configuration for AudioTools based on sample rates,
   channels and encoding. 
   3.a. Remove hard-coded stuff from the various tool invocation commands.
    ...
    def computePESQScore(self):
      ...
      if result:
        ...
        if os.path.exists('browser_output.txt'):
           with open('browser_output.txt', "a") as b_file:
             b_file.write(pesq_report)
           b_file.close()
